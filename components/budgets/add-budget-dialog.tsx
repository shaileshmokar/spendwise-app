...
export type AddBudgetDialogProps = {
  onSave?: (category: {
    type: CategoryType
    name: string
    description: string
...
export function AddBudgetDialog({ onSave }: AddBudgetDialogProps) {
    ...
    <Dialog onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="px-4 sm:max-w-2xl" showCloseButton={false}>
        ...
        <DialogHeader className="relative">
          <DialogTitle className="text-xl font-bold">Add Budget</DialogTitle>

          <DialogDescription>
            Create a new budget to organize your transactions.
          </DialogDescription>
